...
export default function ProjectCard({ name, description, accessTo, _id }: IProject) {
	...
	return (
		<div className="relative bg-[rgb(247,244,243)] p-2 transition duration-300 rounded-md">
				...
				<Dialog isOpen={deleteDialogOpen} setIsOpen={setDeleteDialogOpen}>
					...
					<div className="flex gap-3 justify-end mt-2">
						...
						<button
							...
							type="button"
							className="inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 active:bg-red-600 duration-300 sm:text-sm"
						>
			...
			<p className="pl-2 pb-1 tracking-tighter text-base font-light text-slate-400 min-h-7">{description}</p>
			...
			<div className="flex-col justify-start items-center border rounded-md p-3 bg-white">
				<div className="flex justify-between items-end pb-2">
					...
					<p className="text-xs md:text-sm tracking-tighter px-2 py-1 border rounded-md bg-yellow-600 hover:bg-yellow-700 active:bg-yellow-600 duration-300 cursor-pointer text-white" onClick={() => setSendEnviteDialogOpen(true)}>
						Send Envite
					</p>
						...
						<div className="p-4 pb-0 min-w-56 sm:min-w-80 ">
							<div className="tracking-tighter flex justify-center items-center gap-2">
								...
								<button
									...
									type="button"
									className="inline-flex justify-center rounded-md border shadow-sm px-4 py-2 bg-yellow-600 hover:bg-yellow-700 active:bg-yellow-600 text-white sm:text-base font-light duration-300 text-sm"
								>
								...
								{accessTo.map((email) => (
									<div key={email} className="flex justify-between items-center py-1">
										...
										<XMarkIcon
											...
											className="rounded-full border border-black hover:text-red-800 hover:border-red-800 duration-300 cursor-pointer p-1 flex justify-center items-center size-5 stroke-2"
										/>
									</div>
								))}
							</div>
